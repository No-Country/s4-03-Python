...
class CoffeeHouse(models.Model):
    ...
    celiac  = models.BooleanField(choices=YES_OR_NOT_CHOICES, default=NO)
    bike_friendly = models.BooleanField(choices=YES_OR_NOT_CHOICES, default=NO)
    price_rate = models.IntegerField(default=0, null=True, blank=True)
    toasters = models.BooleanField(choices=YES_OR_NOT_CHOICES, default=NO)
